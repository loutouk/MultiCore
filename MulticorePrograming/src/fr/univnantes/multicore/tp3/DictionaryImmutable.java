...
public class DictionaryImmutable implements Cloneable {
    ...
    private static class Node implements Cloneable {
        ...
        protected Object clone() throws CloneNotSupportedException {
            Node newNode = new Node(this.character, this.next==null ? null : (Node) this.next.clone());
            newNode.absent = this.absent;
            newNode.suffix = this.suffix==null ? null : (Node) this.suffix.clone();
            return newNode;
        }
    }
    ...
    @Override
    protected Object clone() throws CloneNotSupportedException {
        DictionaryImmutable newDictionary = new DictionaryImmutable();
        newDictionary.emptyAbsent = this.emptyAbsent;
        newDictionary.start = this.start==null ? null : (Node) start.clone();
