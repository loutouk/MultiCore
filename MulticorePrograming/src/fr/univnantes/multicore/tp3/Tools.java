...
public final class Tools {
    ...
    public static boolean isEmphasize() {
        return emphasize;
    }

    public static boolean isNoFilename() {
        return noFilename;
    }

    public static boolean isFilesWithMatches() {
        return filesWithMatches;
    }

    public static boolean isOnlyMatching() {
        return onlyMatching;
    }
    ...
    public static boolean isInitialTab() {
        return initialTab;
    }
}
