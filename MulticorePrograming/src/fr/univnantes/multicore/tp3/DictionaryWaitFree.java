 ...
 */
public class DictionaryWaitFree {
    ...
    public boolean add(String s){
        ...
        while(addressesQueue.peek() != s){} // waits until the address we added is at the head of the list
        boolean result = addProtected(addressesQueue.peek()); // compute the result without modifying the list
        addressesQueue.poll(); // we are done editing the structure, so we free the head slot in the concurrent list
        return result;
    }
     ...
     */
    private boolean addProtected(String s) {
